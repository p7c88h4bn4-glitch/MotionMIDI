    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                Text("The status dot beside the dial shows this at a glance while playing: grey for nothing listening, orange when connected, and a green flash on each message sent.")
            }
